...
if ($boton =="Regresar al Menu" )
  ...
  if ($boton =="Salir" )
	...
	if ($boton =="Imprimir" )
   {
  header("location:reportetiempojefe.php?nocedula=$cedula&nocedula1=$cedula1");
  }
?>
<div id="contenedor" align="center">
<form id="form1" name="form1" method="post" action="reportecedulaTjefe.php">
  <p><img src="bannertexto.png" width="1200" height="80" /></p>
