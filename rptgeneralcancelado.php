...
if ($boton =="Imprimir" )
   {
  header("location:rptgrlcancelado.php?tipo=$radio");
  }
...
<form id="form1" name="form1" method="post" action="rptgeneralcancelado.php">
   ...
   if ($boton=="Buscar")
{
            ...
            if ($radio=="grl")
             ...
             $res = pg_query ($conexion, "select sum(total) as total from reportecancelado where estado='CANCELADO' and unidadp='$_SESSION[umf]'")

             or die("Error en la consulta SQL");
             
            
            
            $r = pg_query ($conexion, "select count(total) as tras from reportecancelado  where estado='CANCELADO' and unidadp='$_SESSION[umf]'")
 ...
 echo "<table class='tabla' align='center' width='970' border='1' bgcolor='#FF9900' >
   <tr >
     ...
     <td align='center'>Cancelado</div></td>
