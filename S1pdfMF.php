...
if($_GET["tipo"]=="grl")
{
   /*$result = pg_query ($conexion, "select * from reportecancelado where unidadp='$_SESSION[umf]' and estado='APROBADO'" )

             or die("Error en la consulta SQL");*/

		 $result = pg_query ($conexion, "SELECT * from reportecancelado  where unidadp='$_SESSION[umf]' and estado='APROBADO' and sexo='FEMENINO' and Fecha BETWEEN '$_GET[fecha1]' AND '$_GET[fecha2]' order by fecha")
...
if ($_GET["tipo"]=="ac")
{
 ...
 $result = pg_query ($conexion, "SELECT *from reportecancelado where unidadp='$_SESSION[umf]' and estado='APROBADO' and sexo='MASCULINO' and Fecha BETWEEN '$_GET[fecha1]' AND '$_GET[fecha2]' order by fecha")
