...
if ($boton =="Imprimir" )
   {
  header("location:reportetiempojefetransporte.php?nocedula=$cedula&nocedula1=$cedula1");
  }
?>
<div id="contenedor" align="center">
<form id="form1" name="form1" method="post" action="reportecedulaTtransportejefe.php">
