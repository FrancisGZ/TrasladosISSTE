...
if ($boton =="Imprimir" )
   {
  header("location:S1pdfFecha.php?tipo=$radio&suma=$suma&total=$total&fecha1=$fecha1&fecha2=$fecha2");
  }

?>

<div id="contenedor" align="center">
<form id="form1" name="form1" method="post" action="A1ReporteFecha2.php">
