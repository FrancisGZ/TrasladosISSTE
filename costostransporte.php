...
<form id="form1" name="form1" method="post" action="costosacciontransporte.php">
...
$result = pg_query ($conexion, "Select * from costos2 order by idcosto")
...
while ($renglon=pg_fetch_array ($result))
 ...
 echo "<tr bgcolor='#F2F2F2'>
    <td align='center'>$id</td>
	  ...
	  <td align='center'><a href='costostransporte.php?idcosto=$id&clinica=$clinica&ciudad=$ciudad&costo=$costo'>Editar</a></td>
  </tr>";
