...
<form id="form1" name="form1" method="post" action="usuarioaccion.php">
...
$result = pg_query ($conexion, "Select * from usuarios where departamento='TRASLADOS' order by idusuario")
...
while ($renglon=pg_fetch_array ($result))
 ...
 echo "<tr bgcolor='#F2F2F2'>
    <td align='center'>$id</td>
	  ...
	  <td align='center'><a href='usuarios.php?idusuario=$id&nombre=$nombre&usuario=$usuario&contrasena=$contrasena&nivel=$nivelacce&clinica=$nomunidad&departamento=$depto'>Editar</a></td>
  </tr>";
