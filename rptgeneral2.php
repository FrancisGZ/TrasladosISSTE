...
if ($boton =="Imprimir" )
   {
  header("location:rptgrl.php?tipo=$radio");
  }
...
<form id="form1" name="form1" method="post" action="rptgeneral2.php">
...
if ($radio=="grl")
{
 ...
 $result = pg_query ($conexion, "SELECT * from reporte where unidadp='$_SESSION[umf]';")
...
if ($radio=="ac")
{
 ...
 $result = pg_query ($conexion, "SELECT * from reporte where subac not in (0.00) and unidadp='$_SESSION[umf]'")
...
$result = pg_query ($conexion, "SELECT * from reporte where subac=0.00 and unidadp='$_SESSION[umf]'")
