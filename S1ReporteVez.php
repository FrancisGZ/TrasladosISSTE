...
<form id="form1" name="form1" method="post" action="S1ReporteVez.php">
   ...
   if ($boton=="Buscar")
{
               ...
               $result = pg_query ($conexion, "select count(vez) as totalvez from ordentraslado where estado='APROBADO' and vez='1RA VEZ' and  fecha BETWEEN  '$fecha1' AND '$fecha2'")
               ...
               $res = pg_query ($conexion, "select count(vez) as totalvez2 from ordentraslado where estado='APROBADO' and vez='SUBSECUENTE' and  fecha BETWEEN  '$fecha1' AND '$fecha2'")
...
<tr>
      <td  width='150'>Total 1era Vez</td>
...
<tr>
      <td  width='150'>Total Subsecuente</td>
