...
$conexion = pg_connect("host=localhost dbname=iste user=postgres password=administrador") or
      ...
      die ("Fallo en el establecimiento de la conexión");
            ...
            $result = pg_query ($conexion, "select idordentrans,fecha,cedula,nompasajero,appaterno,apmaterno,nomciudad,costo,nomunidad from reportetransporte 
               where cedula = '$_GET[cedula]'  and nomunidad='$_SESSION[umf]'")
...
$pdf=new PDF();
//Column titles
$header=array('Id Orden','Fecha','Cedula','Nombre','Apellido Paterno','Apellido Materno','Destino','Total','Origen');
$pdf->SetFont('Arial','',5);
$pdf->AddPage();
